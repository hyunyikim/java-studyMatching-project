...
public class UpdateAdminPageService implements Action{
   ...
   public ActionForward execute(HttpServletRequest request, HttpServletResponse response) {
      ...
      try {
         ...
         System.out.println("zzzzzzzzzzzzzzzzz");
           ...
           foward.setPath("/view/mypage/admin/adminpage.jsp");
           session.setAttribute("member_img", member_img);
           session.setAttribute("name", name);
           String test = (String)session.getAttribute("name");
           System.out.println("<<<<<" + test);
           request.setAttribute("hp",hp);
           System.out.println("22222222222222222222222221111111111111111111111");
         }catch(Exception e) {
         e.printStackTrace();
      }
      return foward;
